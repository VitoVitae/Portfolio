 ...
 * \date 26/11/2023
 * 
 * Ce programme est une programme de jeu de sudoku, une joueur doit choisir une grille de sudoku puis essayer de la compléter,
 ...
 * \def TAILLE
 * 
 * \brief constante por la taille du tableau de TAILLE colonnes et lignes (Taille = N*N, ici N=3)
*/
...
{
    tGrille grille1;
    int numLigne, numColonne, valeur, nbrCasesVides,a;
 ...
 * \param S: paramètre de sortie de la valeur lue, un entier compris entre 1 et 3**2 (= Taille)
 * 
...
bool possBloc(tGrille g, int l,int c,int val)
{
    bool res=true;
    int i, j;
    i=l-(l%3); /*i est initialisée à la coordonée de la la ligne de la case en haut à gauche du bloc*/
    j=c-(c%3); /*j est initialisée à la coordonée de la la colonne de la case en haut à gauche du bloc*/
